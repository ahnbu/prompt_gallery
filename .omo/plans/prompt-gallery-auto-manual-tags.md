...
- Evidence: .omo/evidence/task_<N>_prompt-gallery-auto-manual-tags.<ext>
...
- [ ] 1. <title>
  ...
  QA scenarios (name the exact tool + invocation): happy + failure, Evidence .omo/evidence/task_1_prompt-gallery-auto-manual-tags.<ext>
