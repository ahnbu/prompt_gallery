...
- Evidence: .omo/evidence/task-<N>-prompt-gallery-design-application.<ext>
...
- [ ] 1. <title>
  ...
  QA scenarios (name the exact tool + invocation): happy + failure, Evidence .omo/evidence/ui-1-prompt-gallery-design-application.<ext>
